...
- The shape of data_raw is (2, L, 1, N), L is the length of each modulated signal, N is the number of signal samples. The shape of data_feature is (228, N), 228 represents the different adopted traditional features.
